...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        Product item4 = new HotDrink("Latte", 140, (float)0.3, 80);
        Product item5 = new HotDrink("Cacao", 125, (float)0.2, 92);
        ...
        Holder holder1 = new Holder(10, 10);
        CoinDispenser disp = new CoinDispenser(120);

        VendingMachine vendMach1 = new VendingMachine(holder1, disp, assort);
